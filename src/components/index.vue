<template>
  <div class="main">
    ...
    <div class="head">
      <div class="content">
        <div class="head_top">
          <span class="fl">贵阳&nbsp;<img src="/static/images/down3j.png" alt=""></span><img class="logo" src="/static/images/logo.png" alt=""><img class="common_menu fr" src="/static/images/ic_menu@2x.png" alt="">
        </div>
      </div>
    </div>
    <!--搜索栏-->
    ...
    <!--弹出菜单-->
    <div class="main_menu" v-show="false">
      <!--阴影-->
      <div class="bg_shawed">
