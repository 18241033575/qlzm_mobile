<template>
  <div class="main">
    ...
    <div class="head">
      <div class="content">
        <div class="head_top">
          <span class="fl">贵阳&nbsp;<img src="/static/images/down3j.png" alt=""></span><img class="logo" src="/static/images/logo.png" alt=""><img class="main_nav fr" src="/static/images/ic_menu@2x.png" alt="">
        </div>
      </div>
    </div>
    <!--搜索栏-->
