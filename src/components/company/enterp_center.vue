      ...
      <div class="enterp_msg">
        <div class="content">
          ...
          <div class="com_msg fl">
            ...
            <p class="com_msg_det">
              <span>{{centerDetData.nature == 0?'未知性质':centerDetData.nature}}</span><span>|</span><span>{{centerDetData.scale}}</span><span>|</span><span>{{(centerDetData.province) + (centerDetData.city=='未知'?'':centerDetData.city)}}</span>
            </p>
